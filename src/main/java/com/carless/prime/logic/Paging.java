...
public class Paging {
	 ...
	 * 	Sets the page number to store page data for
	 * @param primesPerPage
	 *  Sets the number of items stored per page.   
	 */
	...
	/**
	 * Calculates the lowerbound and upperbound indexes for the requestedPage,
	 * prime values will only be stored if their index falls between these bounds.
	 */
	...
	/**
	 * Stores a prime number data item if it falls on the page this object represents.
	...
	/**
	 * Gets a page of prime data items, the page of data that is returned is based on the page
	 *  number index which is set in the constructor of this object.
	 * @return
	 *   Returns a list of page items. If the page number index is 
	 */
